...
export class ServiceComponent extends VOComponent<R_Service.Aspects.obi> {
...
export class ServiceListItemComponent extends AspectComponent {
  @Input() item: R_Service.Aspects.obi;
