...
export type All = {
  ...
  R_DeviceTree        : { new(): interfaces.R_DeviceTree.Aspects.obi         },
  R_AppTree           : { new(): interfaces.R_AppTree.Aspects.obi            },
...
export const cache = cachedClasses<All>([
  ...
  { name: "R_DeviceTree"        , aspect: "obi", cstor: interfaces.R_DeviceTree         },
  { name: "R_AppTree"           , aspect: "obi", cstor: interfaces.R_AppTree            },
